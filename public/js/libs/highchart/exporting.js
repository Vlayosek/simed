...
(function(a) {
    ...
    function g(a, e, t, n) { a.hasOwnProperty(e) || (a[e] = n.apply(null, t), "function" === typeof CustomEvent && window.dispatchEvent(new CustomEvent("HighchartsModuleLoaded", { detail: { path: e, module: a[e] } }))) }
    a = a ? a._modules : {};
    g(a,
        ...
        function(a, e, t, n) {
            ...
            n = function() {
                function a(b) {
                    ...
                    this.isOpen = !1;
                    b = b.renderTo;
                    this.browserProps || ("function" === typeof b.requestFullscreen ? this.browserProps = { fullscreenChange: "fullscreenchange", requestFullscreen: "requestFullscreen", exitFullscreen: "exitFullscreen" } : b.mozRequestFullScreen ? this.browserProps = {
                ...
                a.prototype.open = function() {
                    ...
                    k(c, "fullscreenOpen", null, function() {
                        ...
                        if (b.browserProps) {
                            var k = l(c.container.ownerDocument, b.browserProps.fullscreenChange, function() { b.isOpen ? (b.isOpen = !1, b.close()) : (c.setSize(null, null, !1), b.isOpen = !0, b.setButtonText()) }),
                                e = l(c, "destroy", k);
                            ...
                            if (p) p["catch"](function() { alert("Full screen is not supported inside a frame.") })
                        }
                    })
                };
    ...
    g(a, "Core/Chart/ChartNavigationComposition.js", [], function() {
        ...
        (function(a) {
            ...
            var e = function() {
                ...
                a.prototype.addUpdate = function(a) { this.chart.navigation.updates.push(a) };
                a.prototype.update = function(a, k) {
                    var e = this;
                    this.updates.forEach(function(b) { b.call(e.chart, a, k) })
                };
                return a
            }();
            a.Additions = e
    ...
    g(a, "Extensions/Exporting/ExportingDefaults.js", [a["Core/Globals.js"]], function(a) {
        ...
        return {
            ...
            lang: { viewFullscreen: "View in full screen", exitFullscreen: "Exit from full screen", printChart: "Print chart", downloadPNG: "Download PNG image", downloadJPEG: "Download JPEG image", downloadPDF: "Download PDF document", downloadSVG: "Download SVG vector image", contextButtonTitle: "Chart context menu" },
            navigation: {
                ...
                menuStyle: { border: "1px solid ".concat("#999999"), background: "#ffffff", padding: "5px 0" },
                menuItemStyle: { padding: "0.5em 1em", color: "#333333", background: "none", fontSize: a ? "14px" : "11px", transition: "background 250ms, color 250ms" },
    ...
    g(a, "Extensions/Exporting/ExportingSymbols.js", [], function() {
        ...
        (function(a) {
            ...
            var g = [];
            a.compose = function(a) {-1 === g.indexOf(a) && (g.push(a), a = a.prototype.symbols, a.menu = e, a.menuball = l.bind(a)) }
        })(a || (a = {}));
        return a
    });
        ...
        var l = a.doc,
            ...
            b = {
                ajax: function(a) {
                    ...
                    p(a.headers, function(a, b) { c.setRequestHeader(b, a) });
                        ...
                        if (4 === c.readyState) {
                            if (200 === c.status) {
                                if ("blob" !== a.responseType) {
                                    ...
                                    if ("json" === a.dataType) try { b = JSON.parse(b) } catch (x) {
                                        if (x instanceof Error) { a.error && a.error(c, x); return }
                                    }
                                }
                ...
                getJSON: function(a, e) { b.ajax({ url: a, success: e, dataType: "json", headers: { "Content-Type": "text/plain" } }) },
                post: function(a, b, e) {
                    var c = g("form", k({ method: "post", action: a, enctype: "multipart/form-data" }, e), { display: "none" }, l.body);
                    p(b, function(a, b) { g("input", { type: "hidden", name: b, value: a }, void 0, c) });
                    c.submit();
                    z(c)
                }
            };
        ...
        (function(e) {
            function n(a) {
                ...
                if (!1 !== c.enabled && c.theme) {
                    ...
                    c.text && c.symbol ? f.paddingLeft = y(f.paddingLeft, 30) : c.text || D(f, { width: c.width, height: c.height, padding: 0 });
                    d.styledMode || (f["stroke-linecap"] = "round", f.fill = y(f.fill, "#ffffff"), f.stroke = y(f.stroke, "none"));
                    var u = b.button(c.text, 0, 0, I, f).addClass(a.className).attr({ title: y(d.options.lang[c._titleKey || c.titleKey], "") });
                    u.menuClassName = a.menuClassName || "highcharts-menu-" + d.btnCount++;
                    if (c.symbol) {
                        var l =
                            b.symbol(c.symbol, c.symbolX - r / 2, c.symbolY - r / 2, r, r, { width: r, height: r }).addClass("highcharts-button-symbol").attr({ zIndex: 1 }).add(u);
                        d.styledMode || l.attr({ stroke: c.symbolStroke, fill: c.symbolFill, "stroke-width": c.symbolStrokeWidth || 1 })
                    }
                    u.add(d.exportingGroup).align(D(c, { width: u.width, x: y(c.x, d.buttonOffset) }), !0, "spacingBox");
            ...
            function z() {
                if (this.printReverseInfo) {
                    ...
                    [].forEach.call(c, function(a, d) { 1 === a.nodeType && (a.style.display = b[d] || "") });
                    this.isPrinting = !1;
            ...
            function F() {
                var a = l.body,
                    ...
                    b = { childNodes: a.childNodes, origDisplay: [], resetParams: void 0 };
                this.isPrinting = !0;
                ...
                [].forEach.call(b.childNodes, function(a, d) { 1 === a.nodeType && (b.origDisplay[d] = a.style.display, a.style.display = "none") });
            ...
            function T(d, b, e, H, K, m, r) {
                ...
                if (!h) {
                    ...
                    var q = C("ul", { className: "highcharts-menu" }, { listStyle: "none", margin: 0, padding: 0 }, h);
                    f.styledMode || v(q, D({ MozBoxShadow: "3px 3px 10px #888", WebkitBoxShadow: "3px 3px 10px #888", boxShadow: "3px 3px 10px #888" }, w.menuStyle));
                    h.hideMenu = function() {
                        v(h, { display: "none" });
                        r && r.setState(0);
                        f.openMenu = !1;
                        v(f.renderTo, { overflow: "hidden" });
                        v(f.container, { overflow: "hidden" });
                        c.clearTimeout(h.hideTimer);
                        E(f, "exportMenuHidden")
                    };
                    f.exportEvents.push(x(h,
                        "mouseleave",
                        function() { h.hideTimer = A.setTimeout(h.hideMenu, 500) }), x(h, "mouseenter", function() { c.clearTimeout(h.hideTimer) }), x(l, "mouseup", function(a) { f.pointer.inClass(a.target, d) || h.hideMenu() }), x(h, "click", function() { f.openMenu && h.hideMenu() }));
                    b.forEach(function(d) {
                        ...
                        if (O(d, !0)) {
                            ...
                            }, void 0, q), a.setElementHTML(b, d.text || f.options.lang[d.textKey]), f.styledMode || (b.onmouseover = function() { v(this, w.menuItemHoverStyle) }, b.onmouseout = function() { v(this, w.menuItemStyle) }, v(b, D({ cursor: "pointer" }, w.menuItemStyle || {}))));
                ...
                v(h, b);
                v(f.renderTo, { overflow: "" });
                v(f.container, { overflow: "" });
                f.openMenu = !0;
                E(f, "exportMenuShown")
            }
            ...
            function U(a) {
                ...
                a = d.exportEvents;
                var l;
                b && (b.forEach(function(a, c) { a && (a.onclick = a.ontouchstart = null, l = "cache-" + a.menuClassName, d[l] && delete d[l], b[c] = a.destroy()) }), b.length = 0);
                d.exportingGroup && (d.exportingGroup.destroy(),
                    delete d.exportingGroup);
                e && (e.forEach(function(a, d) { a && (c.clearTimeout(a.hideTimer), Q(a, "mouseleave"), e[d] = a.onmouseout = a.onmouseover = a.ontouchstart = a.onclick = null, J(a)) }), e.length = 0);
            ...
            function V(a, c) {
                ...
                b.post(a.url, { filename: a.filename ? a.filename.replace(/\//g, "-") : this.getFilename(), type: a.type, width: a.width || 0, scale: a.scale, svg: c }, a.formAttributes)
            }
            ...
            function Y(a) {
                ...
                var c = C("div", null, { position: "absolute", top: "-9999em", width: this.chartWidth + "px", height: this.chartHeight + "px" }, l.body),
                ...
                D(d.chart, { animation: !1, renderTo: c, forExport: !0, renderer: "SVGRenderer", width: e, height: m });
                d.exporting.enabled = !1;
                delete d.data;
                d.series = [];
                this.series.forEach(function(a) {
                    b = q(a.userOptions, { animation: !1, enableMouseTracking: !1, showCheckbox: !1, visible: a.visible });
                    b.isInternal || d.series.push(b)
                });
                var g = {};
                this.axes.forEach(function(a) {
                    a.userOptions.internalKey || (a.userOptions.internalKey = R());
                    a.options.isInternal || (g[a.coll] || (g[a.coll] = !0, d[a.coll] = []), d[a.coll].push(q(a.userOptions, { visible: a.visible })))
                });
                ...
                this.axes.forEach(function(a) {
                    var d = N(f.axes, function(d) { return d.options.internalKey === a.userOptions.internalKey }),
                        b = a.getExtremes(),
                        c = b.userMin;
                    b = b.userMax;
            ...
            function Z(a, b) {
                ...
                return this.getSVG(q({ chart: { borderRadius: 0 } }, d.chartOptions,
                    b, { exporting: { sourceWidth: a && a.sourceWidth || d.sourceWidth, sourceHeight: a && a.sourceHeight || d.sourceHeight } }))
            }

            function aa(a) { return a.replace(/([A-Z])/g, function(a, b) { return "-" + b.toLowerCase() }) }
            ...
            function ba() {
                ...
                v(m, { width: "1px", height: "1px", visibility: "hidden" });
            ...
            function ea(a) {
                (this.fixedDiv ? [this.fixedDiv, this.scrollingContainer] : [this.container]).forEach(function(d) { a.appendChild(d) })
            }
            ...
            function ha() {
                ...
                a.isPrinting || (G = a, p.isSafari || a.beforePrint(), setTimeout(function() {
                    A.focus();
                    A.print();
                    p.isSafari || setTimeout(function() { a.afterPrint() }, 1E3)
                }, 1))
            }
            ...
            function ia() {
                ...
                e && !1 !== b.enabled && (a.exportEvents = [], a.exportingGroup = a.exportingGroup || a.renderer.g("exporting-group").attr({ zIndex: 3 }).add(), P(c, function(b) { a.addButton(b) }), a.isDirtyExporting = !1)
            }
