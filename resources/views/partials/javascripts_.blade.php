...
<script src="{{ asset('adminlte3/plugins/datatables-select/js/dataTables.select.min.js') }}"></script>
<!-- AdminLTE App -->
...
<script src="{{ asset('adminlte3/plugins/datatables-buttons/js/buttons.flash.min.js') }}"></script>
<script src="{{ asset('adminlte3/plugins/datatables-select/js/select.bootstrap4.min.js') }}"></script>
...
<script src="{{ url('npm\select2\dist\js') }}/select2.full.min.js"></script>
